...
namespace vm
{
	...
	constexpr WORD OP_EQUAL =		0b00000000000000000000000000010000;
	constexpr WORD OP_NEQUAL =		0b00000000000000000000000000010001;
	constexpr WORD OP_GREATER =		0b00000000000000000000000000010010;
	constexpr WORD OP_GREQUAL =		0b00000000000000000000000000010011;
	constexpr WORD OP_LESS =		0b00000000000000000000000000010100;
	constexpr WORD OP_LSEQUAL =		0b00000000000000000000000000010101;
	...
	public:
		...
		bool loadImage(ExecutableImage& const image);               // Load executable image
